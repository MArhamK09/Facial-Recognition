...
def generate_dataset(img, id, img_id):
    ...
    cv2.imwrite("data/user_"+str(id)+"/user."+str(id)+"."+str(img_id)+".jpg", img)
...
def detect(img, faceCascade, img_id):
    ...
    if len(coords)>0:
        ...
        if not os.path.exists(".//data//user_"+str(user_id)):
            os.mkdir(".//data//user_"+str(user_id))
    return img
